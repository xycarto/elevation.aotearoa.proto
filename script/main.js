...
function insert() { 
    ...
    $('body').append('<div class="landboxframe"></div>');
        $('.landboxframe').append('<div class="landbox1"></div>');
            $('.landbox1').append('<div class="landbox1inner-left" data-href="http://localhost:8000/discover.html"></div>');
            ...
            $('.landbox1').append('<div class="landbox1inner-middle" data-href="http://localhost:8000/discover.html"></div>');
            ...
            $('.landbox1').append('<div class="landbox1inner-right" data-href="http://localhost:8000/discover.html"></div>');
        ...
        $('.landboxframe').append('<div class="landbox2"></div>');
            $('.landbox2').append('<div class="landbox2inner-left" data-href="http://localhost:8000/discover.html"></div>');
            ...
            $('.landbox2').append('<div class="landbox2inner-middle" data-href="http://localhost:8000/discover.html"></div>');
